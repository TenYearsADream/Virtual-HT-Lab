...
void MenuFunc(int MenuItem)// 菜单项处理函数
{
	...
	switch(MenuItem)
	{
	case 0:scene=0;step=0;dis();break;
	case 1:scene=1;step=0;dis();break;
	case 2:scene=2;step=0;dis();break;
	case 3:scene=3;step=0;dis();break;
	case 4:scene=4;step=0;dis();break;
	case 5:scene=5;step=0;dis();break;
	case 6:scene=6;step=0;dis();break;
	case 11:scene=11;step=0;dis();break;
	case 12:scene=12;step=0;dis();break;
	case 13:scene=13;step=0;dis();break;
	case 14:scene=14;step=0;dis();break;
	case 15:scene=15;step=0;dis();break;
	case 16:scene=16;step=0;dis();break;

	case 21:mover_H_ai=2*mover_L_ai;scene=0;step=0;dis();break;
	case 22:mover_H_ai=3*mover_L_ai;scene=0;step=0;dis();break;
	case 23:mover_H_ai=4*mover_L_ai;scene=0;step=0;dis();break;
...
{     
	...
	#pragma region glut template
	glutInitDisplayMode(GLUT_DOUBLE | GLUT_RGBA); // 定义窗口特征：单缓存、RGBA颜色模式
...
//	glutMotionFunc(mouseMotion);
 ...
 myinit_model(4,"../../../3DS/4_collector_blu.3DS");
 myinit_model(5,"../../../3DS/4_collector_wht.3DS");
 myinit_model(6,"../../../3DS/5_wind_tunnel_blk.3DS");
 myinit_model(7,"../../../3DS/5_wind_tunnel_gry.3DS");
// myinit_model(8,"../../../3DS/5_wind_tunnel_none.3DS");
 myinit_model(8,"../../../3DS/5_wind_tunnel_wht.3DS");
 myinit_model(9,"../../../3DS/6_anemoscope_blu.3DS");
 myinit_model(10,"../../../3DS/6_anemoscope_blu_lgt.3DS");
 myinit_model(11,"../../../3DS/6_anemoscope_wht.3DS");
 myinit_model(12,"../../../3DS/6_anemoscope_wire_blk.3DS");
 myinit_model(13,"../../../3DS/6_anemoscope_wire_wht.3DS");
 myinit_model(14,"../../../3DS/8_shelf_wht_1.3DS");
 myinit_model(15,"../../../3DS/8_shelf_wht_2.3DS");
 myinit_model(16,"../../../3DS/9_oven_blu.3DS");
 myinit_model(17,"../../../3DS/9_oven_door_blu.3DS");
// myinit_model(19,"../../../3DS/9_oven_door_none.3DS");
 myinit_model(18,"../../../3DS/9_oven_gry.3DS");
 myinit_model(19,"../../../3DS/9_oven_wht.3DS");
 myinit_model(20,"../../../3DS/C_box.3DS");
 myinit_model(21,"../../../3DS/D_screw_blu.3DS");
 myinit_model(22,"../../../3DS/D_screw_wht.3DS");
 myinit_model(23,"../../../3DS/e_scissors_wht.3DS");
 myinit_model(24,"../../../3DS/e_scissors_yel.3DS");
 myinit_model(25,"../../../3DS/f_room_celling.3DS");
 myinit_model(26,"../../../3DS/f_room_wall.3DS");
 myinit_model(27,"../../../3DS/f_room_floor.3DS");
 myinit_model(28,"../../../3DS/f_room_door.3DS");
 myinit_model(29,"../../../3DS/f_room_scene.3DS");
